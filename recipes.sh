...
cb recipe delete --name metron-db-centos-setup
...
cb recipe create from-file --name metron-db-centos-setup --execution-type post-ambari-start --file db_centos_setup.sh
