...
cb mpack create --name hcp170 --url "http://public-repo-1.hortonworks.com/HCP/centos6/1.x/updates/1.7.0.0/tars/metron/hcp-ambari-mpack-1.6.0.0-38.tar.gz" --description "HCP 1.7.0"
